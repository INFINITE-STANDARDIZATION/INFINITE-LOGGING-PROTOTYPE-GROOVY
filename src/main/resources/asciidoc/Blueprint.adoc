...
NOTE: "Outer" transformation means outside corresponding *visit* method of the expression. "Inner" means inside "visit" method.
...
|DeclarationExpression|*Not* wrapped into MethodCallExpression; transformed into ListOfExpressionsExpression having the below expressions:
...
* Right expression is transformed|Outer|
...
|BinaryExpression|Standard transformation|* rightExpression
* leftExpression (only when operation is *not* "Assignment" ("="))|Outer|

|BitwiseNegationExpression|Standard transformation|* expression
|Outer|

|NotExpression|Standard transformation|* expression
|Outer|

|BooleanExpression|Standard transformation|* expression
|Outer|

|CastExpression|Standard transformation|* expression
|Outer|

|ConstructorCallExpression|Standard transformation|* arguments
|Outer|

|MethodPointerExpression|Standard transformation|* expression
* methodName
|Outer|

|AttributeExpression|Standard transformation|* objectExpression
* property
|Outer|

|PropertyExpression|Standard transformation|* objectExpression
* property
|Outer|

|RangeExpression|Standard transformation|* from
* to
|Outer|

|SpreadExpression|Standard transformation|* expression
|Outer|

|SpreadMapExpression|Standard transformation|* expression
|Outer|

|StaticMethodCallExpression|Standard transformation|* arguments
|Outer|

|ElvisOperatorExpression|Standard transformation|* trueExpression
* falseExpression
|Outer|

|TernaryExpression|Standard transformation|* booleanExpression
* trueExpression
* falseExpression
|Outer|

|UnaryMinusExpression|Standard transformation|* expression
|Outer|

|UnaryPlusExpression|Standard transformation|* expression
|Outer|
