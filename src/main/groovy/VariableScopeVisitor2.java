 ...
 */
public class VariableScopeVisitor2 extends ClassCodeVisitorSupport {

    protected VariableScope currentScope = null;
    ...
    private class StateStackElement {
        ...
        StateStackElement() {
            scope = VariableScopeVisitor2.this.currentScope;
            clazz = VariableScopeVisitor2.this.currentClass;
            inConstructor = VariableScopeVisitor2.this.inConstructor;
        }
    }

    public VariableScopeVisitor2(SourceUnit source, boolean recurseInnerClasses) {
        this.source = source;
    ...
    public VariableScopeVisitor2(SourceUnit source) {
        this(source, false);
    }
